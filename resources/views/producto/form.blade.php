<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="modelo" class="form-control @error('modelo') is-invalid @enderror" value="{{ old('modelo', $producto?->modelo) }}" id="modelo" placeholder="Modelo">
            {!! $errors->first('modelo', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
            <label for="especificaciones_tecnicas" class="form-label">{{ __('Especificaciones Tecnicas') }}</label>
            <input type="text" name="especificaciones_tecnicas" class="form-control @error('especificaciones_tecnicas') is-invalid @enderror" value="{{ old('especificaciones_tecnicas', $producto?->especificaciones_tecnicas) }}" id="especificaciones_tecnicas" placeholder="Especificaciones Tecnicas">
            {!! $errors->first('especificaciones_tecnicas', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
        </div>
        <div class="form-group mb-2 mb20">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="marca_id" class="form-control @error('marca_id') is-invalid @enderror" value="{{ old('marca_id', $producto?->marca_id) }}" id="marca_id" placeholder="Marca Id">
